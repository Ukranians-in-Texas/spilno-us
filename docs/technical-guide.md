...
**Companion docs:** [concepts.md](concepts.md) explains unfamiliar patterns anchored to how this project uses them — read proxy, RLS, serverless functions, JWT, and the data model. [walkthrough.md](walkthrough.md) traces each major feature end-to-end with annotated code excerpts. Read this guide for the *what* and *why*; read those for the *how* and *how-it-connects*.
